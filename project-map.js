  ...
  nodes: [
    ...
    },
    {
      ...
      parts: [
        ...
        { label: "Token → wl_buffer (4.3) — now reachable", status: "active", desc: "With the starvation fixed, vkcube reaches swapchain buffer creation for the first time: three create_immed intercepts binding buffers 21/23/25 to resources 8/9/10 at 500x500 XR24, via the fd->token correlation. The WaylandArg::Buffer(_) arm — unreachable all week — is now being reached, which is exactly what 4.3 exists to fill. vkcube still aborts, later and on a different thread; that wall is new and undiagnosed." }
      ],
